    ...
    <nav className="py-10">
      <Container>
        <div className="flex items-center">
          ...
          <div
            className={`lg:w-7/12 w-full bg-gradient-to-b from-gray-600 to-gray-900 lg:bg-none fixed lg:static top-0 left-0 h-full lg:h-auto p-10 lg:p-0 transition-all ${
          ...
          <div
            className={`lg:w-3/12 absolute lg:static w-full left-0 px-10 lg:px-0 trasition-all ${
